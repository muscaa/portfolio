...
export default function Footer() {
    return (
        <div className="bg-background-2 bg-opacity-50 backdrop-blur-lg shadow-top shadow-background-1 flex flex-col justify-center items-center text-center py-8 space-y-4">
