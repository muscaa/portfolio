        ...
        return (
            <>
                <textarea
                    ...
                    class={cn(
                        "[&::-webkit-scrollbar-track]:bg-blue border-input bg-background text-foreground placeholder:text-muted-foreground focus-visible:ring-ring flex min-h-[60px] w-full rounded-md border px-3 py-2 p shadow-xs transition-all focus-visible:ring-1 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
                        props.class,
                    )}
                    id={textareaId}
                />
