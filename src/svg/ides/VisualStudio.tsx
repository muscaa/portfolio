...
export default function VisualStudio({ className }: { className?: string }) {
    return (
        ...
        >
            <defs>
                <linearGradient id="vs_a" x1="48" x2="48" y1="97.75" y2="2.25" gradientTransform="matrix(1 0 0 -1 0 97.75)" gradientUnits="userSpaceOnUse">
